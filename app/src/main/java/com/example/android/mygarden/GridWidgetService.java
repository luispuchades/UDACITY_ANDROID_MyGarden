...
class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    /**
     * Called on start when notifyAppWidgetViewDataChanged is called
     */
    @Override
    ...
    public RemoteViews getViewAt(int position) {
        ...
        int waterTimeIndex = mCursor.getColumnIndex(PlantContract.PlantEntry
        ...
        int imgRes = PlantUtils.getPlantImageRes(mContext, timeNow - createdAt, timeNow -
                wateredAt, plantType);
        ...
        // Fill in the onClick PendingIntent Template using the specific plan Id for eacht item
        // individually
